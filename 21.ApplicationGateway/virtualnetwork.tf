...
resource "azurerm_subnet" "appgateway_subnet01" {
  name                 = "appgateway-sub01"
  resource_group_name  = azurerm_resource_group.rg01.name
  virtual_network_name = azurerm_virtual_network.east_vnet01.name
...
resource "azurerm_subnet" "appgateway_subnet02" {
  name                 = "appgateway-sub02"
  resource_group_name  = azurerm_resource_group.rg01.name
  virtual_network_name = azurerm_virtual_network.east_vnet01.name
  address_prefixes     = ["172.16.210.0/24"]
